...
public final class GeneradorInforme {
    ...
    private static Map<String, Persona> datosPersonas;
    private static Map<String, Integer> datosRepetidos;
    private static Map<String, Persona> datosErroneos;
    private static Map<String, Persona> datosCortos;
