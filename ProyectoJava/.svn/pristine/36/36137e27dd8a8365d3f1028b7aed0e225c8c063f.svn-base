...
public class Persona {
	...
	addToBuffer(sb, this.dni);
	addToBuffer(sb, this.nombre);
	addToBuffer(sb, this.apellido);
	addToBuffer(sb, String.valueOf(this.edad));
	addToBuffer(sb, this.poblacion);
	addToBuffer(sb, this.categoria);
	return sb.toString();
    }

    private StringBuilder addToBuffer(final StringBuilder sb, final String what) {
	return sb.append(what).append(' ');
    }
}
